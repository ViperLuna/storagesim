...
export const UNITS: UnitDef[] = [
  { id: 'locker', name: 'Locker', w: 1, h: 1, timer: 60, listPrice: 10, cost: 50, demand: 5, color: '#4f8fd6', unlockRebirth: 0 },
  { id: 'small', name: 'Small', w: 1, h: 2, timer: 180, listPrice: 72, cost: 350, demand: 3, color: '#3fae8f', unlockRebirth: 0 },
  { id: 'medium', name: 'Medium', w: 2, h: 2, timer: 540, listPrice: 540, cost: 2500, demand: 2, color: '#d6a84f', unlockRebirth: 0 },
  { id: 'large', name: 'Large', w: 2, h: 3, timer: 1440, listPrice: 2592, cost: 12000, demand: 1, color: '#d6744f', unlockRebirth: 0 },
  { id: 'xl', name: 'XL', w: 2, h: 4, timer: 3600, listPrice: 10560, cost: 50000, demand: 0.5, color: '#a45fd6', unlockRebirth: 0 },
]
